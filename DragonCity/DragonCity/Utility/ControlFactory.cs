...
namespace tranduytrung.DragonCity.Utility
{
    public static class ControlFactory
    {
        ...
        public static Button CreateSmallButton(string text, SpriteFont font, Texture2D normalBackground, Texture2D hoverBackground, Texture2D pressBackground)
        {
            var button = CreateFitContentButton(text, font, normalBackground, hoverBackground, pressBackground);
            button.Width = ControlConfig.SmallButtonWidth;
            button.Height = ControlConfig.SmallButtonHeight;
